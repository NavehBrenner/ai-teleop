...
from kpi_data import DEFAULT_RUNS_ROOT, Recipe, load_recipes  # noqa: E402
...
def paired_deltas(recipe: Recipe) -> list[float]:
    ...
    for point in recipe.points:
        ...
        pairs = [
            (trial.min_tip_hole_distance_mm, baseline[trial.seed].min_tip_hole_distance_mm)
        ...
        if usable:
            deltas.append(statistics.mean(a - b for a, b in usable))
    return deltas
