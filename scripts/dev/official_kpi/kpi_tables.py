...
FT_DAGGER_ROUNDS_NOTE = (
    ...
    "backfilling them was only ever done for vision (LAB-112). So the round sweep below is "
...
def build_markdown(recipes: dict[str, Recipe], runs_root: Path, policy_runs_root: Path) -> str:
    ...
    parts: list[str] = [
        ...
        "**mean over training seeds `[min, max]`**, never as a single checkpoint (LAB-114).",
        "",
