...
This document fixes the evaluation methodology: the configurations compared, the KPIs, and — most importantly — the experimental design that makes the headline claim statistically and methodologically defensible. This is the rationale behind the evaluation plan presented at the design review.
