...
Companion docs: [problem-structure.md](problem-structure.md) (notation, the four streams, the learning objective) · [human-generation.md](human-generation.md) · [expert-corrections.md](expert-corrections.md). Refines [`../design-document.md`](../design-document.md) Component 4.
